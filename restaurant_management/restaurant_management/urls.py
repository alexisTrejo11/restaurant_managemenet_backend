...
urlpatterns = [
    ...
    path('v1/api/reservations/<int:pk>/', ReservationViews.as_view({'get': 'getReservationById', 'delete': 'deleteReservationById'}), name='stock-detail'),
    ...
    path('v1/api/reservations/by', ReservationViews.as_view({'get': 'getReservationsByFilter'}), name='reservations-dateRange'),
